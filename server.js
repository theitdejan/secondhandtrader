...
// Class requires
const ClassWrapper = require('./server/Wrappers/WoW/ClassWrapper');
const ClassUrls = require('./server/Urls/WoW/Class');
...
// TODO: all us
app.get(ClassUrls.Request.All.EU, (req, res) => {
	ClassWrapper.all("EU")
		.then(classes => {
...
// TODO: single us
app.get(ClassUrls.Request.Single.EU, (req, res) => {
	const { id } = req.params;
	if (_.isUndefined(id) || id <= 0) {
		return res.status(400).send({
			error: "Id parameter has to be present, and greater than 0."
